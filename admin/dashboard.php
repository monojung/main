...
$stmt = $conn->prepare("SELECT COUNT(*) as count FROM appointments WHERE appointment_date LIKE ?");
$stmt->execute([$this_month . '%']);
$appointments_month = $stmt->fetch(PDO::FETCH_ASSOC)['count'];
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center">
                        <div class="text-3xl text-blue-600 mr-4">📅</div>
                        <div>
                            <h3 class="text-2xl font-bold text-gray-800"><?php echo $appointments_today; ?></h3>
                            <p class="text-gray-600">นัดหมายวันนี้</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center">
                        <div class="text-3xl text-green-600 mr-4">📊</div>
                        <div>
                            <h3 class="text-2xl font-bold text-gray-800"><?php echo $appointments_month; ?></h3>
                            <p class="text-gray-600">นัดหมายเดือนนี้</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center">
                        <div class="text-3xl text-yellow-600 mr-4">⏳</div>
                        <div>
                            <h3 class="text-2xl font-bold text-gray-800"><?php echo $pending_appointments; ?></h3>
                            <p class="text-gray-600">รอการยืนยัน</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        ...
                        <?php else: ?>
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        ?>
                                        <span class="px-3 py-1 rounded-full text-xs font-medium <?php echo $status_colors[$appointment['status']]; ?>">
                            ...
                            <div class="text-center mt-6">
                                <a href="appointments.php" class="text-blue-600 hover:text-blue-800 font-medium">ดูทั้งหมด →</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <a href="news.php?action=add" class="bg-green-600 text-white p-4 rounded-lg text-center hover:bg-green-700 transition duration-300">
                                <div class="text-2xl mb-2">📰</div>
                                <div class="font-medium">เพิ่มข่าวสาร</div>
                            </a>
                            
                            <a href="patients.php" class="bg-purple-600 text-white p-4 rounded-lg text-center hover:bg-purple-700 transition duration-300">
                                <div class="text-2xl mb-2">👥</div>
                                <div class="font-medium">ข้อมูลผู้ป่วย</div>
                            </a>
                            
                            <a href="reports.php" class="bg-orange-600 text-white p-4 rounded-lg text-center hover:bg-orange-700 transition duration-300">
                                <div class="text-2xl mb-2">📊</div>
